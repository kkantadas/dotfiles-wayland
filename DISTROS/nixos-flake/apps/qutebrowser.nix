{ pkgs, ... }:
  {
    ...
    home.file.".config/qutebrowser/qute-theme.py".source = ./qutebrowser/qute-theme.py;
    home.file.".config/qutebrowser/adblock.py".source = ./qutebrowser/adblock.py;
    home.file.".config/qutebrowser/themes/".source = ./qutebrowser/themes;
